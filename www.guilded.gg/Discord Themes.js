...
export const load = async () => {
  ...
  for (const sheet of window.document.styleSheets) {
    let themeVars = [
      ...
      ['--background-secondary-alt, var(--background-secondary)', 'rgba(60, 62, 72, 0.7)'],
      ['--background-tertiary', '#1e2025'],
      ['--background-secondary-alt, var(--background-secondary)', '#191b1f'],
      ['--background-secondary-alt, var(--background-secondary)', '#1e2025'],
