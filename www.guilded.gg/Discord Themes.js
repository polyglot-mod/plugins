...
export const load = async () => {
  ...
  for (const sheet of window.document.styleSheets) {
    let themeVars = [
      ...
      ['--background-secondary-alt, --background-secondary', 'rgba(60, 62, 72, 0.7)'],
      ['--background-tertiary', '#1e2025'],
      ['--background-secondary-alt, --background-secondary', '#191b1f'],
      ['--background-secondary-alt, --background-secondary', '#1e2025'],
      ['--channeltextarea-background, --background-tertiary', '#4e4f59'],
